...
namespace GoofyGhosts
{
    ...
    public class MouseLook : MonoBehaviour
    {
        ...
        [Tooltip("A SensitivitySettings ScriptableObject to determine the mouse look sensitivity.")]
        ...
        private void LateUpdate()
        {
            ...
            float horizontalRot = mouseDelta.x * Time.deltaTime * sensitivitySettings.yawSensitivity;
            float verticalRot = mouseDelta.y * Time.deltaTime * sensitivitySettings.pitchSensitivity;

            // Add our inputs to the yaw and pitch.
            yaw += (sensitivitySettings.inverseYaw) ? -horizontalRot : horizontalRot;
            pitch += (sensitivitySettings.inversePitch) ? -verticalRot : verticalRot;
